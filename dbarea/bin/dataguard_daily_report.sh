...
set lines 300 
set feedback off
spool /u00/app/admin/dbarea/log/dataguard_daily_report.log
@/u00/app/admin/dbarea/sql/dg_daily_report.sql
spool off
exit
EOSQL


/bin/mailx -s " opdb standby daily report" cwopsdba@cisco.com < $LOG_DIR/dataguard_daily_report.log
